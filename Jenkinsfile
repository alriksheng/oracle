pipeline {
  parameters {
    ...
    string(defaultValue: 'step5.sql', description: 'SQL_FILE', name: 'SQL_FILE')
    string(defaultValue: 'step5_temp.sql', description: 'SQL_FILE_TEMP', name: 'SQL_FILE_TEMP')
    string(defaultValue: 'checkResult_step5.sql', description: 'SQL_FILE2', name: 'SQL_FILE2')

pipeline {
  parameters {
    ...
    string(defaultValue: 'checkResult.sql', description: 'SQL_FILE2', name: 'SQL_FILE2')
    string(defaultValue: 'checkResult1.sql', description: 'SQL_FILE_TEMP2', name: 'SQL_FILE_TEMP2')
    ...
    //string(defaultValue: '20190730', description: 'mth_end', name: 'mth_end')

pipeline {
  parameters {
    ...
    string(defaultValue: 'step6.sql', description: 'SQL_FILE', name: 'SQL_FILE')
    string(defaultValue: 'step6_temp.sql', description: 'SQL_FILE_TEMP', name: 'SQL_FILE_TEMP')
    string(defaultValue: 'checkResult_step6.sql', description: 'SQL_FILE2', name: 'SQL_FILE2')
    string(defaultValue: 'checkResult_step6_temp.sql', description: 'SQL_FILE_TEMP2', name: 'SQL_FILE_TEMP2')
  ...
  stages {
    ...
    stage("2nd schema check") {
      steps {
        script{
          // to int
          def data_mth_int = params.DATA_mth1 as Integer
          mth_end_int = data_mth_int + 29
          // to string
          mth_end_str = mth_end_int as String
          // powershell
          powershell "Get-Content ${params.FILE_PATH_SQL}/${params.SQL_FILE_TEMP2} | ForEach-Object {\$_ -replace ('DATA_mth','${params.DATA_mth1}') -replace ('mth_end', '${mth_end_str}') }| Set-Content ${params.FILE_PATH_SQL}/${params.SQL_FILE2}"

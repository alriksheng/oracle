pipeline {
  parameters {
    ...
    string(defaultValue: 'step4.sql', description: 'SQL_FILE', name: 'SQL_FILE')
    string(defaultValue: 'step4_temp.sql', description: 'SQL_FILE_TEMP', name: 'SQL_FILE_TEMP')
    string(defaultValue: 'checkResult_step4.sql', description: 'SQL_FILE2', name: 'SQL_FILE2')
    string(defaultValue: 'checkResult_step4_temp.sql', description: 'SQL_FILE_TEMP2', name: 'SQL_FILE_TEMP2')

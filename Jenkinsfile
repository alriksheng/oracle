pipeline {
  ...
  stages {
    stage("1st schema call") {
      steps {
        powershell "Get-Content ${params.FILE_PATH_SQL}/${params.SQL_FILE_TEMP} | ForEach-Object {\$_ -replace ('DATA_d1','${params.DATA_d1}+1')} | Set-Content ${params.FILE_PATH_SQL}/${params.SQL_FILE}"
